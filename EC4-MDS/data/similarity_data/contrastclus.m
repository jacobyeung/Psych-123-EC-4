function [clusters,weights,vaf,gcc,complexity,rho]=contrastclus(similarity,precision,labels,evidence,patience)

% [clusters,weights,vaf,gcc,gc,rho]=contrastclus(similarity,precision,labels,evidence,patience)
...
while newgcc-mingcc<evidence
   ...
   displayrepn_b(bestseenf,bestseenw,bestseenvaf,bestseenrho,labs,m,bestseengcc,bestseenc)
   drawnow
