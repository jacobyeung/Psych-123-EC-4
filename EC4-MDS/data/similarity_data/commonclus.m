function [clusters,weights,vaf,gcc,complexity,rho]=commonclus(similarity,precision,labels,evidence,patience)

% [clusters,weights,vaf,gcc,gc,rho]=commonclus(similarity,precision,labels,evidence,patience)
...
while newgcc-mingcc<evidence
   ...
   displayrepn_c(bestseenf,bestseenw,bestseenvaf,bestseenrho,labs,m,bestseengcc,bestseenc)
   drawnow
